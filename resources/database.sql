...
DROP TABLE IF EXISTS `customers_banking`;
CREATE TABLE `customers_banking` (
...
INSERT INTO `customers_banking` VALUES
...
CREATE TABLE `accounts` (
  ...
  CONSTRAINT `accounts_FK` FOREIGN KEY (`customer_id`) REFERENCES `customers_banking` (`customer_id`)
